...
session_start();
$bookModel = new Book();
$bookId = isset($_GET['id']) ? base64_decode($_GET['id']) : '';
...
<body class="bg-dark text-light">
    <div class="container mt-3">
        ...
        <form action="../../app/Controllers/handelform.php?id=<?= $book['id']?>" method="post" enctype="multipart/form-data" style="width:50vw; min-width:300px;">
                <div class="card">
                    <img src="<?= $book['cover']?>" alt="image" id="image">
                ...
                <select class="form-select mb-3" aria-label="Default select example" name="genre">
                    <option selected><?= $book['genre']?></option>
                ...
                <div class="mb-3">
                    <input type="text" class="form-control" name="publication" placeholder="Publication Year" value="<?= $book['publication_year']?>">
                </div>

                <div class="mb-3">
                    <input type="number" class="form-control" name="total_copies" placeholder="Total Copies" value="<?= $book['total_copies']?>">
                </div>

                <div class="mb-3">
                    <input type="number" class="form-control" name="available_copies" placeholder="Available Copies" value="<?= $book['available_copies']?>">
                </div>

                <div class="row ms-1 mt-4">
                    <button type="submit" class="btn btn-success col-3 me-3" name="edit">Publish</button>
